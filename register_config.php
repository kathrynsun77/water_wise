...
$sql = "INSERT INTO users (fname, lname, uname, password, email, mobile, gender, user_type, user_status,photo) VALUES ('$fname','$lname','-','$password','$email',0,'-',3,1,'/assets/images/img_profile1.png')";
$conn->query($sql);
